...
function signedIn(nav,user,csrf){
 ...
 nav.innerHTML=`<span class="name" title="${esc(label)}">${esc(label)}</span><a href="/my-consultations">My Consultations</a><a href="/my-reviews">My Reviews</a><button type="button" data-logout>Log out</button>`;
