...
$css='<style id="techselectai-partner-discovery-style">.ts-product-follow,.ts-partner-discovery{margin-top:34px;padding:24px;border:1px solid #d8e5ec;border-radius:16px;background:#f8fbfd}.ts-product-follow h2,.ts-partner-discovery h2{margin:5px 0 8px}.ts-product-follow p,.ts-partner-discovery p{color:#64748b;line-height:1.6}.ts-product-follow button,.ts-partner-discovery a{display:inline-flex;padding:10px 14px;border:0;border-radius:10px;background:#123b67;color:#fff!important;text-decoration:none;font-weight:750;cursor:pointer}.ts-product-follow button[aria-pressed="true"]{background:#0f766e}.ts-product-follow button:disabled{opacity:.65;cursor:wait}.ts-product-follow small,.ts-partner-discovery small{display:block;margin-top:12px;color:#64748b;line-height:1.5}</style><script src="/product_follow.js" defer></script>';
$html=str_ireplace('</head>',$css.'</head>',$html);
$html=preg_replace('#<section class="cta">#',$follow.$section.'<section class="cta">',$html,1)??$html;
echo $html;
