...
$map=file_get_contents($root.'/software_logo_map.php');
...
$checks=[
    ...
    'map only exposes active products'=>str_contains($map,"status='active'"),
    'map restricts paths to media/software'=>str_contains($map,"str_starts_with($path,'media/software/')"),
...
if(preg_match('/clearbit|logo\.dev|brandfetch|g2\.com|capterra/i',$map.$js.$backfill)){
