...
if(str_contains($class,'Scoring::')||str_contains($class,'recommendation_runs')||str_contains($class,'sponsor'))$errors[]='comparison SEO priority layer appears coupled to scoring/ranking/sponsorship';
