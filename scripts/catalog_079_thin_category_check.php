...
$migration = $root . '/db/mysql/079_expand_thin_categories_batch1.sql';
...
$require(stripos($sql, 'INSERT INTO categories') === false, '079 must not create categories.');
$require(stripos($sql, 'INSERT INTO modules') === false, '079 must not create modules.');
$require(stripos($sql, 'INSERT INTO capabilities') === false, '079 must not create capabilities.');

$products = [
    'cortex-xsiam' => 'siem-security-operations',
    'onelogin-workforce-identity' => 'identity-access-management',
    'one-identity-safeguard-privileged-passwords' => 'privileged-access-management',
    'infor-wms' => 'warehouse-management-systems',
    'servicenow-app-engine' => 'low-code-bpm',
    'creatio-sales' => 'crm',
    'paycom' => 'hr-hcm',
    'ifs-cloud-erp' => 'erp',
];
...
$require(strpos($sql, 'ON DUPLICATE KEY UPDATE') !== false, '079 must be idempotent.');
...
$officialHosts = [
    'paloaltonetworks.com','onelogin.com','oneidentity.com','support.oneidentity.com',
    'infor.com','docs.infor.com','servicenow.com','creatio.com','paycom.com','ifs.com'
];
...
$require(strpos($sql, "'public-saas'") !== false, '079 must include conservative SaaS deployment facts where verified.');
$require(strpos($sql, "'on-premise'") !== false, '079 must include verified on-premise deployment fact for Safeguard.');
...
echo "Catalog 079 thin-category contract passed.\n";
