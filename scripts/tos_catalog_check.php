...
foreach(array_merge([$category],$products) as $slug){
    ...
    foreach($migrations as $file){
        ...
        if(in_array(basename($file),['139_tos_depth_taxonomy_foundation.sql','140_tos_kaleris_n4_depth_evidence.sql','141_tos_market_names_zodiac_master_terminal.sql','142_tos_cyberlogitec_opus_depth_evidence.sql','143_tos_rbs_tops_expert_depth_evidence.sql','144_tos_total_soft_bank_catos_depth_evidence.sql','145_tos_tideworks_mainsail_depth_evidence.sql'],true))continue;
