...
foreach(array_merge([$category],$products) as $slug){
    ...
    foreach($migrations as $file){
        ...
        if(in_array(basename($file),['139_tos_depth_taxonomy_foundation.sql','140_tos_kaleris_n4_depth_evidence.sql','141_tos_market_names_zodiac_master_terminal.sql'],true))continue;
